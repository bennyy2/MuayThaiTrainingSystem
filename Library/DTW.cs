...
namespace MuayThaiTraining
{
    class DTW
    {
        ...
        //public void DTWPath(List<Position> input, string pose, string room, int col)
        //{
        ...
        //public double DTWDistance(List<Position> input)
        //{
        //    int rows = input.Count;
        ...
        //public double DTW_improved(List<Position> input)
        //{
        ...
        //public Tuple<double[,], double[,]> modifiedDTW(JointType first, JointType sec, string poseName, string roomName, List<Position> input, int col)
        //{
        //    int rows = input.Count;
        //    int columns = col;
        ...
        //    return result;
        //}
        ////public Tuple<double[,], double[,]> modifiedDTW(List<Position> input, string pose, string room)
        ////{
        ////    int rows = input.Count;
